  ...
  return (
    <>
      ...
      <div className="md:grid md:grid-cols-3 gap-3 py-4">
        ...
        <div className="md:col-span-3 w-full flex flex-grow items-center justify-center flex-col mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl px-4">
            <Link
              to="/analytics"
              className="bg-purple-600 hover:bg-purple-700 text-white py-4 px-6 rounded-lg shadow-md text-center font-semibold"
            >
              📈 View Analytics
            </Link>
            <Link
              to="/certificate"
              className="bg-green-600 hover:bg-green-700 text-white py-4 px-6 rounded-lg shadow-md text-center font-semibold"
            >
              🎓 Download Certificate
            </Link>
            <Link
              to="/leaderboard"
              className="bg-blue-600 hover:bg-blue-700 text-white py-4 px-6 rounded-lg shadow-md text-center font-semibold"
            >
              🏆 Leaderboard
            </Link>
          </div>
